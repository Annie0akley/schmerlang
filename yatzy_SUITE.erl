...
-export([create_new_sheet_test/1, get_bonus_score_test/1, get_upper_total_score_test/1, get_lower_total_score_test/1]).
-export([get_grand_total_score_test/1, get_all_uppers_score_test/1, get_all_lowers_score_test/1]).
...
groups() ->
    [
        ...
        },
        {
            get_scores,
            [],
            [all_filled_true_test, all_filled_false_test, create_new_sheet_test, get_bonus_score_test, get_upper_total_score_test,
            get_upper_total_score_test, get_grand_total_score_test, get_all_uppers_score_test, get_all_lowers_score_test]
        },
        {
            fill_upper_scores,
            [],
...
get_lower_total_score_test(_Config) ->
    Sheet = yatzy_sheet:new(),
    0 = yatzy_sheet:get_score(lower_total, Sheet).

get_upper_total_score_test(_Config) ->
    Sheet = yatzy_sheet:new(),
    0 = yatzy_sheet:get_score(upper_total, Sheet).
...
fill_fours_test(_Config) ->
    Sheet3 = #{ones => 2, twos => 4, threes => 6, upper_total => 12, bonus => 0, lower_total => 12},
    Sheet4 = #{ones => 2, twos => 4, threes => 6, fours => 20, upper_total => 32, bonus => 0, lower_total => 12},
...
fill_fives_test(_Config) ->
    ...
    Sheet5 = #{ones => 2, twos => 4, threes => 6, fours => 20, fives => 25, upper_total => 57, bonus => 0, lower_total => 0},
    Sheet5 = yatzy_sheet:fill(fives, [5,5,5,5,5], Sheet4).

fill_sixes_test(_Config) ->
    Sheet5 = #{ones => 2, twos => 4, threes => 6, fours => 20, fives => 25, upper_total => 57, bonus => 0, lower_total => 0},
    Sheet6 = #{ones => 2, twos => 4, threes => 6, fours => 20, fives => 25, sixes => 12, upper_total => 69,
        bonus => 50, lower_total => 0},
...
fill_small_straight_test(_Config) ->
    Sheet12 = #{ones => 2, twos => 4, threes => 6, fours => 20, fives => 25, sixes => 12,
        upper_total => 69, bonus => 50, one_pair => 4, three_of_a_kind => 9, four_of_a_kind => 8,
        yatzy => 0, two_pairs => 10, full_house => 13, lower_total => 64},
    Sheet13 = #{ones => 2, twos => 4, threes => 6, fours => 20, fives => 25, sixes => 12,
        upper_total => 69, bonus => 50, one_pair => 4, three_of_a_kind => 9, four_of_a_kind => 8,
        yatzy => 0, two_pairs => 10, full_house => 13, small_straight => 15, lower_total => 79},
